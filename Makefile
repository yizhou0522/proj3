...
all: main.o linked_list.o graph.o  reader.o option_parser.o command_executor.o validator.o
	$(CC) -o $(EXE) main.o  linked_list.o graph.o reader.o option_parser.o command_executor.o validator.o

clean:
	rm -f $(EXE) *.o
	rm -rf $(SCAN_BUILD_DIR)

main.o: linked_list.h graph.h 
...
reader.o: reader.h reader.c linked_list.h  graph.h
